...
@Entity(name = "Agenda") //Define o nome da tabela que será criada no banco de dados
public class Post implements Serializable {

	private static final String TÍTULO_É_UMA_INFORMAÇÃO_OBRIGATÓRIA = "Título é uma informação obrigatória.";
	...
	@Column(nullable = false, length = 150, unique = true) //Define propriedades da coluna
	...
	@NotBlank(message = TÍTULO_É_UMA_INFORMAÇÃO_OBRIGATÓRIA)
